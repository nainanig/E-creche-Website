...
var tb_pathToImage = "/images/static/ajax_loader_white.gif";
...
function tb_show(caption, url, imageGroup) {//function called when the user clicks on a thickbox link
	...
	try {
		...
		jQuery("body").append("<div id='TB_load'></div>");//add loader to the page //removed loader reference
	   ...
	   var urlType = baseURL.toLowerCase().match(urlString);
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			TB_WIDTH = (params['width']*1) + 30 || 830; //defaults to 630 if no paramaters were added to URL
			...
			jQuery("#TB_closeWindowButton").click(function (){
				jQuery("div.carousel_images > ul", '.slideshow').cycle('resume'); //resumes slideshow
				tb_remove();
			});
